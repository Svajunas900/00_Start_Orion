...
class DataReceiver:
    ...
    def clean_data(self):
        # method clean_data should remove all none unicode symbols from text
    ...
    def return_json_text(self):
        # method return_json_text should return the json object with params:
        # "URL" - input user url, "message" - the cleaned text
